...
public class GivenWhiteBox {
  ...
  //Testing node coverage {All nodes}
    ...
    public void testingNodeCoverage()
    {
    	...
    	Bear customBear3 = new Bear(Stuffing.stuffing.BASE); //will have 7 clothes and 5 noise makers - 2 free clothes and 10 percent off
    	...
    	Bear customBear4 = new Bear(Stuffing.stuffing.BASE); //Some embroidery to check if that works full price no discount
    	...
    	//double bear = bears.getCost(customBear); //free = 30 package deal get cost does not work for that
    	...
    	double raw = bears.getRawCost(customBear)+bears.getRawCost(customBear2)+bears.getRawCost(customBear3)+bears.getRawCost(customBear4);
